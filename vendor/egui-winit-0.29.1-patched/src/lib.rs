...
impl State {
    ...
    pub fn on_window_event(
        ...
        match event {
            ...
            WindowEvent::Ime(ime) => {
                // NOTE: IME handling on Linux was historically disabled (see
                // https://github.com/emilk/egui/issues/5008) because it made
                // some keys stop working on older winit. With modern winit
                // (0.30+) and Wayland text-input-v3 this works correctly, and
                // is REQUIRED for CJK (e.g. Chinese) input via fcitx5.
                //
